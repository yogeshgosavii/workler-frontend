    ...
    <div className={`${className}`} {...props}>
      <div className={`flex flex-col w-full ${className}`}>
        <label
          ...
          htmlFor="email"
          className="font-semibold ml-1 mb-2 flex flex-row"
        >
        ...
        <div className="flex flex-row flex-wrap border rounded-sm ">
          <input
            ...
            value={inputValue}
            id="otpInput"
            className=" bg-white  flex-grow w-10  px-3 py-3 rounded-sm focus:bg-gray-50 duration-200 placeholder:text-gray-400  outline-none no-spin-buttons flex-1"
            style={{
