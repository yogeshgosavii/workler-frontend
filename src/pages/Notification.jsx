...
function Notification({ userId }) {
  ...
  return (
    <div className=" flex flex-col bg-gray-50 h-full items-center w-full sm:pl-1.5">
      <p className={`text-2xl  font-bold ${loading || notifications.length == 0 ?"border-b border-x" :"border-x"} px-4 w-full  sticky max-w-xl  -top-0 bg-white z-40 py-4 `}>
        Notifications
      </p>
      <div>
