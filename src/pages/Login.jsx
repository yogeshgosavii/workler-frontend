        ...
        <div className='bg-white flex sm:max-w-sm w-full flex-row mt-0.5 sm:border'>
          <div className='w-full px-6 pt-10 sm:p-10 duration-200'>
            {userType === "employeer" ? (
              ...
              <h2 className="text-2xl font-semibold leading-tight">Candidate login</h2>
            )}
            <p className='text-gray-400 text-sm font-normal'>Enter your registered email and password</p>
            <p id='error' className={`text-red-500 px-2 mt-1 w-fit rounded-sm text-sm bg-red-50 ${error ? "" : "invisible"}`}>{error}</p>
            ...
            <form className='mt-16' >
              <div className="relative flex peer">
                <input
                  ...
                  title="Email address"
                />
                <label htmlFor="userEmail" onClick={(e) => { e.preventDefault(); e.target.previousSibling.focus(); }} className="absolute duration-200 cursor-text px-2 text-gray-400 bg-white font-normal transform -translate-y-5 scale-90 top-2 z-10 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-90 peer-focus:-translate-y-5 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Email address</label>
              </div>
              ...
              <div className="relative flex peer mt-5">
                ...
                <label
                    ...
                    onClick={(e) => { e.preventDefault(); e.target.previousSibling.focus(); }}
              ...
              <Button
                ...
                className="w-full flex py-2.5 justify-center text-xl mt-8 duration-200 font-semibold  text-white bg-blue-500 disabled:bg-blue-300"
              >
                {true ? (
