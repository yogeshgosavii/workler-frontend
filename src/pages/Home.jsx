...
function Home() {
  ...
  return (
    ...
    <div className='mt-24'>
        ...
        <p className='text-xl text-gray-400 font-medium md:font-semibold mt-2'>Lets get your career started right away</p>
   ...
   <div className='sm:text-center mt-24'>
    ...
    <div className=' mt-8 sm:mt-14 -ml-5 sm:-ml-10 -mr-5 sm:-mr-10  flex overflow-x-scroll gap-5 px-5 py-10 ' style={{ '-ms-overflow-style': 'none', 'scrollbar-width': 'none', '::-webkit-scrollbar': { display: 'none' } }}>
        {
            topCompanies.map((topCompany)=>{
               return(
                <div className=' flex flex-col transition duration-300 ease-in-out transform hover:scale-110 border justify-between p-8 rounded-lg hover:shadow-xl cursor-pointer min-w-72  aspect-auto  w-1/3'>
                    <div>
                    ...
                    <Button className={"mt-6 pr-3  hover:bg-blue-50 hover:border-blue-500 text-blue-500  w-fit flex justify-between items-center border-2 gap-5 "}>
                        Apply
                        <svg class="h-8 w-8  text-blue-500"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polyline points="9 18 15 12 9 6" /></svg>
                    </Button>
                </div>
                )
            })
