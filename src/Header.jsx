...
function Header() {
  ...
  return (
    <div className={`${(isAuthenticated || location.pathname.startsWith("/job/")) && "hidden"} w-full fixed top-0 bg-white z-20 flex justify-center border-b-2 sm:border-none sm:shadow-md`}>
